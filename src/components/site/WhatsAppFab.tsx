const WhatsAppFab = () => (
  <a
    ...
    className="fixed bottom-6 right-6 z-50 group flex items-center gap-3 bg-[#25D366] text-white pl-4 pr-5 h-14 rounded-full shadow-[0_20px_50px_-15px_rgba(37,211,102,0.6)] hover:scale-105 transition-transform duration-300"
  >
    ...
    <span className="hidden md:inline text-xs uppercase tracking-[0.22em] font-medium">WhatsApp</span>
  </a>
);
